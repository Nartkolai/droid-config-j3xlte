...
%define device j3xlte
%define vendor samsung

%define vendor_pretty Samsung
%define device_pretty J320F
...
%include patterns/patterns-sailfish-device-adaptation-j3xlte.inc
%include patterns/patterns-sailfish-device-configuration-j3xlte.inc
